...
activities = {
    ...
    "Soccer Team": {
        "description": "Team practices and match play for soccer enthusiasts",
    ...
    "Basketball Club": {
        ...
        "max_participants": 18,
        "participants": ["maria@mergington.edu", "jason@mergington.edu"]
    },
    "Art Studio": {
    ...
    "Science Club": {
        ...
        "max_participants": 16,
        "participants": ["kate@mergington.edu", "ryan@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice public speaking and debate current issues",
        "schedule": "Mondays, 4:30 PM - 6:00 PM",
        "max_participants": 14,
        "participants": ["alexis@mergington.edu", "ben@mergington.edu"]
    },
    "Tennis Club": {
    ...
    "Photography Club": {
        "description": "Explore photography techniques and create visual art projects",
    ...
    "Robotics Club": {
        ...
        "max_participants": 18,
        "participants": ["chris@mergington.edu", "zoe@mergington.edu"]
    },
    "Math Club": {
        "description": "Solve challenging math problems and prepare for competitions",
        "schedule": "Mondays and Wednesdays, 3:30 PM - 4:30 PM",
        "max_participants": 15,
        "participants": ["andrew@mergington.edu", "victoria@mergington.edu"]
    }
}
